...
function useGridParamsApi(apiRef) {
  ...
  const getCellValue2 = React71.useCallback((id, field) => {
    const colDef = apiRef.current.getColumn(field);
    const row = apiRef.current.getRow(id);
    if (!row) {
      throw new MissingRowIdError(`No row with id #${id} found`);
...
true ? GridColumnHeaderItem.propTypes = {
  ...
  isLastUnpinned: import_prop_types33.default.bool.isRequired,
  isResizing: import_prop_types33.default.bool.isRequired,
  isSiblingFocused: import_prop_types33.default.bool.isRequired,
...
true ? GridRow.propTypes = {
  ...
  dimensions: import_prop_types65.default.shape({
    ...
    groupHeaderHeight: import_prop_types65.default.number.isRequired,
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const goToCell = React147.useCallback((colIndex, rowId, closestColumnToUse = "left", rowSpanScanDirection = "up") => {
...
var useGridRowSpanning = (apiRef, props) => {
  ...
  const lastRange = React174.useRef(EMPTY_RANGE);
  const updateRowSpanningState = React174.useCallback(
  ...
  const prevRenderContext = React174.useRef(renderContext);
  const isFirstRender = React174.useRef(true);
  const shouldResetState = React174.useRef(false);
  React174.useEffect(() => {
...
var DataGridRaw = React175.forwardRef(function DataGrid(inProps, ref) {
...
var DataGrid2 = React175.memo(DataGridRaw);
DataGridRaw.propTypes = {
   ...
   */
  columnGroupHeaderHeight: import_prop_types67.default.number,
   ...
   * @default false
   */
  unstable_rowSpanning: import_prop_types67.default.bool
};
export {
